...
object SizeUtils {
    ...
    fun dp2px(dpValue: Float): Int {
        val scale = VideoEditApplication.getAppContext().getResources().getDisplayMetrics().density
    ...
    fun sp2px(spValue: Float): Int {
        val fontScale = VideoEditApplication.getAppContext().getResources().getDisplayMetrics().scaledDensity
    ...
    fun applyDimension(value: Float, unit: Int): Float {
        val metrics = VideoEditApplication.getAppContext().getResources().getDisplayMetrics()
        when (unit) {
