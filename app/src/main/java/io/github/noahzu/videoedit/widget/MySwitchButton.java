...
//        colorPrimary = a.getColor(R.styleable.MySwitchButton_primaryColor, DEFAULT_COLOR_PRIMARY);
        colorPrimary = ContextCompat.getColor(getContext(), R.color.color_theme);
        colorPrimaryDark = a.getColor(R.styleable.MySwitchButton_primaryColorDark, DEFAULT_COLOR_PRIMARY_DARK);
        colorOff = a.getColor(R.styleable.MySwitchButton_offColor, 0xFFE3E3E3);
        colorOffDark = a.getColor(R.styleable.MySwitchButton_offColorDark, 0xFFBFBFBF);
        colorShadow = a.getColor(R.styleable.MySwitchButton_shadowColor, 0xFF333333);
        colorBar = a.getColor(R.styleable.MySwitchButton_barColor, 0xFFFFFFFF);
        colorBackground = a.getColor(R.styleable.MySwitchButton_bgColor, 0xFFFFFFFF);
        ratioAspect = a.getFloat(R.styleable.MySwitchButton_ratioAspect, 0.68f);
        hasShadow = a.getBoolean(R.styleable.MySwitchButton_hasShadow, true);
        isOpened = a.getBoolean(R.styleable.MySwitchButton_isOpened, false);
    ...
    public void setChecked(boolean checked) {
        int wishState = checked ? STATE_SWITCH_ON : STATE_SWITCH_OFF;
        if (wishState == state) {
            return;
        }
    ...
    public interface OnStateChangedListener {
        void toggleToOn(MySwitchButton view);

        void toggleToOff(MySwitchButton view);
    }
    ...
    private OnCheckedChangeListener mOnCheckedChangeListener = new OnCheckedChangeListener() {
        @Override
        public void onCheckedChanged(MySwitchButton view, boolean isChecked) {
    ...
    private OnStateChangedListener listener = new OnStateChangedListener() {
        @Override
        public void toggleToOn(MySwitchButton view) {
            toggleSwitch(true);
        }

        @Override
        public void toggleToOff(MySwitchButton view) {
            toggleSwitch(false);
        }
    };
